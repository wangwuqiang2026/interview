...
<font style="color:rgb(51,51,51);">       Mybatis是一个半ORM（对象关系映射）框架，它内部封装了JDBC，开发时只需要关注SQL </font>
...
<font style="color:rgb(51,51,51);">       MyBatis 可以使用 XML 或注解来配置和映射原生信息，将 POJO映射成数据库中的记录，避 </font>
...
<font style="color:rgb(51,51,51);">      通过xml 文件或注解的方式将要执行的各种 statement 配置起来，并通过java对象和 </font>
